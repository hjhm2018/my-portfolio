        ...
        <div className="row justify-content-center">
          <Card className="col-lg-4" style={{ width: "18rem" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                A website with the most common petrophysics equations used in
          ...
          <Card className="col-lg-4" style={{ width: "18rem" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                A website with the most common petrophysics equations used in
                the oil and gas industry for Spanish speakers.
              </Card.Text>
              <ModalTwo />
            </Card.Body>
          </Card>
          <Card className="col-lg-4" style={{ width: "18rem" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                An app published at Google Play with the most common
                petrophysics equations used in the oil and gas industry.
              </Card.Text>
              <ModalThree />
            </Card.Body>
          </Card>
          <Card className="col-lg-4" style={{ width: "18rem" }}>
            ...
            <Card.Body>
              ...
              <Card.Text>
                A landing page for a real client through the Riipen platform
