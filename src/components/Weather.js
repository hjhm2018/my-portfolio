    ...
    render() {
        ...
        return (
            <div className="text-center">
                <h1 className="text-center bg-dark text-light p-2 rounded sticky-top col-12 mt-2 mb-2"><span role="img" aria-label="sun emoji">&#127774;</span> Weather App <span role="img" aria-label="hurricane emoji">&#127744;</span> </h1>
                <div className="mb-4">
